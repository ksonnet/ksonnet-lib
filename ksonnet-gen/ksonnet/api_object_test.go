...
func TestAPIObject_Node_with_type(t *testing.T) {
	...
	t1 := NewType("io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta", "desc", "group", "ver", "Kind", nil)
	ao := NewAPIObject(t1)
...
func TestAPIObject_Node_fails_when_renderer_fails(t *testing.T) {
	...
	ao.renderFieldsFn = func(typeLookup, *nm.Object, string, map[string]Field) error {
